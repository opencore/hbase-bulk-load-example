 ...
 * https://github.com/cloudera/hbase/blob/cdh5-1.2.0_5.14.0/hbase-server/src/main/java/org/apache/hadoop/hbase/mapreduce/HFileOutputFormat2.java
 *
...
public class PatchedHFileOutputFormat2
        extends FileOutputFormat<ImmutableBytesWritable, Cell> {
  private static final Log LOG = LogFactory.getLog(PatchedHFileOutputFormat2.class);
